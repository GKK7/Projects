...
# Set the model path and load the unet model
model_id = "/home/gkirilov/Brand_new_PC/van_gogh/dreambooth_dreamshaper_6BakedVae_steps_20000_lr_4e-06_batch_1"
unet = UNet2DConditionModel.from_pretrained(model_id+"/checkpoint-10000/unet")
...
for main_prompt in prompts:
    ...
    out_dir = f"/home/gkirilov/Checkpoint/van_gogh/"
    ...
    image = pipe_img2img(prompt=prompt, guidance_scale=8, image=image, strength=0.65, negative_prompt=negative).images[
        0]
