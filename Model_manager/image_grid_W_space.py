...
def process_subdirectory(subdirectory):
    ...
    for root, dirs, files in os.walk(subdirectory):
        for file in files:
            if file.endswith(".png") and '512' not in file:  # ignore files with '512' in their name
...
if __name__ == "__main__":
    directory = '/home/gkirilov/Checkpoint/JENNAORTEGAX_solo_raw'  # Put your directory path here
    main(directory)
