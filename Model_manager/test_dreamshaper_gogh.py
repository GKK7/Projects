...
instance_data_dir = "/home/gkirilov/Brand_new_PC/images_50"
output_dir = "/home/gkirilov/Brand_new_PC/jenna_text_encoder/dreambooth"
instance_prompt = "JENNAORTEGAX"
resolution = 512
batch_size = 1
...
lr_warmup_steps = 0
max_train_steps_list = [400, 800, 1200, 1600, 2000, 2500]
...
for lr in learning_rate_list:
    for steps in max_train_steps_list:
        ...
        with open(f"{log_dir}log_jenna_encoder.txt", "a") as log_file:
            log_file.write(
