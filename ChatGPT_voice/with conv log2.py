...
def main():
    while True:
        ...
        logging.info("Say 'Hello' to start recording your question or 'Goodbye' to exit the program.")
        with sr.Microphone() as source:
            ...
            try:
                ...
                if transcription.lower() == "hello":
                    # Record audio
                    filename = "input.wav"
                    logging.info("Ask your question")
                    with sr.Microphone() as source:
                        recognizer = sr.Recognizer()
                    ...
                    if text:
                        ...
                        logging.info(f"Chat GPT-3 says: {response}")
